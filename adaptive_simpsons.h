...
#ifndef __ADAPTIVESIMPSONINTEGRATION_H
#define __ADAPTIVESIMPSONINTEGRATION_H

class AdaptiveSimponsIntegration
{

public:
Real m_epsilon;// = 0.000000001;
int m_maxRecursionDepth;// = 15;
 AdaptiveSimponsIntegration(Real eps = 0.0001, int dep=12, const char* fn=(char*)0):m_epsilon(eps),m_maxRecursionDepth(dep)
{
